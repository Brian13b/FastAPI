...
def inicializa_datos_contacto(db):
    ...
    """
    db.add(Contacto(id=1, nombre='Contacto1', direccion=Direccion(calle="Cucha Cucha", numero=123), telefonos='tel1', fecha_nac=datetime.date(1999, 8, 23)))
    db.add(Contacto(id=2, nombre='Contacto2', direccion=Direccion(calle="calle cto 2", numero=456, piso=1, depto='A')))
