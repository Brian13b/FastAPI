...
class Config: 
    ...
    def load_settings(self, filepath: Path): # Carga los settings desde un archivo
        if not filepath.exists():   
            return None # Si el archivo no existe, se retorna None

        try: # Se intenta cargar los settings del archivo
