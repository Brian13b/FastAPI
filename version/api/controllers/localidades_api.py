...
from api.model.localidad_modelos import LocalidadListModel, LocalidadDetailModel, LocalidadCreateModel, LocalidadUpdateModel, LocalidadResponseModel
...
@localidades_router.get('/provincias/{prov_id}/localidades', response_model=List[LocalidadDetailModel], summary='Devuelve todas las localidades de una provincia')
